...
| 2    | [ณัฏฐกิตติ์ 682110113] | Core mechanic `Update()` logic        | Phase 2–3 (Hour 6–24)        |
| 3    | [ธีรภัทร 682110121]       | Render/`SpriteBatch` + Collision      | Phase 2–3 (Hour 6–24)        |
| 4    | [กนต์ระพี 682110104]     | Content pipeline (MGCB) + Audio/UI      | Phase 3–4 (Hour 14–34)       |
